...
const NavBar = () => {
  return (
    <div className='bg-[#F7F8FA] border-b border-[#d2d3d4] w-full flex items-center justify-between  h-28 px-10'>
      <div>
        <h1 className='font-[Gilroy] text-xl'>Dashboard</h1>
      </div>

      <div className='flex items-center gap-4 border rounded-full border-gray-300 px-4 py-2'>
        <div className='w-10 h-10 flex items-center justify-center rounded-full bg-[#262043]'>
